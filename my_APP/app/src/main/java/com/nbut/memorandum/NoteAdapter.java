...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> {
    private Context mContext;
    private List<Note> mNoteList;
    private OnNoteDeleteListener deleteListener; // 删除回调接口
    int[] tag_color = {R.drawable.tag_yellow, R.drawable.tag_blue, R.drawable.tag_green, R.drawable.tag_red, R.drawable.tag_white};
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) { // view是RecyclerView子项(CardView)的最外层布局
            ...
            deleteButton = view.findViewById(R.id.delete_button); // 新增删除按钮
     ...
     * 定义接口
     */
    private ItemClickListener mItemClickListener; // 点击事件
    private ItemLongClickListener mItemLongClickListener; // 长按事件
    ...
    public interface OnNoteDeleteListener { // 新增接口，用于删除
        ...
        holder.deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (deleteListener != null) {
                    deleteListener.onNoteDelete(oneNote, position);
                }
            }
        });
